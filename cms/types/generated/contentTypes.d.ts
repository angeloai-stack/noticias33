...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Secci\u00F3n editorial (Editorial, Pol\u00EDtica, Deportes\u2026)';
...
export interface ApiNoticiaNoticia extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Art\u00EDculo de noticias para el sitio N33';
    displayName: 'Noticia';
    pluralName: 'noticias';
  ...
  attributes: {
    autorNombre: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Redacci\u00F3n N33'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cuerpo: Schema.Attribute.RichText & Schema.Attribute.Required;
